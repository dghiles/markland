...
- **Soak-window analytics check** — beads `markland-fjd` (~2 weeks post-launch, due **2026-05-15**, ~5 days out): pull Umami stats + `/admin/metrics` 14d funnel snapshot + cross-reference signups vs Umami sessions, post a 1-message summary. Partial data already pulled 2026-05-05 (6 users, 12 docs, 3 private user docs); full check pending.
